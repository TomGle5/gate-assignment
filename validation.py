...
#TODO finish this later (only allow transfers to j if j dep after i arrives)
# def find_later_ac(ac_list, arrival_times):
#     later_ac = []
#     for ac in ac_list:
#         current_arrival = arrival_times[ac]
#         if
...
print(f"{'i':<3} {'P_arr':<10} {'cnx_pct':<10} {'cnx_pax_arr':<12} {'Pi0':<5} {'cnx_pax_arr + Pi0'}")
print("-" * 65)
for i in aircraft:
    print(f"{i:<3} {P_arr[i]:<10} {cnx_pct[i]:<10} {cnx_pax_arr[i]:<12} {Pi0[i]:<5} {cnx_pax_arr[i]+Pi0[i]}")
